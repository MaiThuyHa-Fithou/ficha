...
public class GameGraphics {
    ...
    public ImageView createEgg(int position, String color) {
        ...
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) getMyLayoutParams(RelativeLayout.ALIGN_PARENT_TOP);
    ...
    protected ViewGroup.LayoutParams getMyLayoutParams(int rule) {
